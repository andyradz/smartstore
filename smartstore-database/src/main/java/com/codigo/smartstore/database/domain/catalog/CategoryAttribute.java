...
public class CategoryAttribute
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "categoryattribute_generator")
	@TableGenerator(name = "categoryattribute_generator", initialValue = 0, allocationSize = 50)
	private Long id;
