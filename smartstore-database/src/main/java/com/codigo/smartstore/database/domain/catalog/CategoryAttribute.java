...
// // "categoryattribute_generator")
// // @TableGenerator(name = "categoryattribute_generator", initialValue = 0,
// // allocationSize = 50)
// protected Long id;
//
// @Column(name = "Name")
...
// result = (prime * result) + Objects.hash(this.id, this.name, this.searchable,
// this.value);
// return result;
// }
//
