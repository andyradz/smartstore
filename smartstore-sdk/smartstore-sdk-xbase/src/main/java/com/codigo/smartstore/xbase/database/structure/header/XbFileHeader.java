...
public class XbFileHeader {
	...
	/**
	 * @return the lastUpdateYear
	 */
	public byte getLastUpdateYear() {

		return this.lastUpdateYear;
	}

	/**
	 * @return the lastUpdateMonth
	 */
	...
	/**
	 * @return the mdxStatus
	 */
	public byte getMdxStatus() {

		return this.mdxStatus;
	}
