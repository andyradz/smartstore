...
public enum XbCodePages {
	 ...
	 * braku obsługi ustawianie jest domyślne kodowanie ASCII.
	 *
	...
	public static Charset ofCodepage(final int codepage) {
		...
		final Supplier<XbCodePages> operator = (
			...
			return annotation instanceof DefaultEnumItem
					? DefaultEnumItem.class.cast(annotation)
							.value()
						: XbCodePages.ASCII;
		};
	...
	/**
	 * Metoda sprawdza i wyszukuje czy obsługuje wskazany rodzaj kodowania znaków. W
	 * przypadku braku obsługi ustawiana jest domyślna strona kodowa o numerze 0.
	 *
	 * @param charset Rodzaj kodowania znaków
