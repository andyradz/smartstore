...
public class Polynomial {
	...
	// TODO: współczynniki woelomiany zdefiniować jako osobne obiekty, które będą
	// przrchowywały wartość
	// -----------------------------------------------------------------------------------------------------------------
	public Polynomial() {
	...
	public HashSet<Long> getFactors() {
...
//
// if expectedSts == 'REGD';
// if not verifyTagValue ( XPath = 'InstrPrcgSts/Accptd/Rsn/RsnCd/Cd', val =
/// expectedRsnCd );
// rsnCd = getTagValue ( XPath =
/// 'RequestPayload/Document/DsclInstrStsAdvc/InstrPrcgSts/Accptd/Rsn/RsnCd/Cd',
// tagValueMaxLen = 4 );
// log('Dla $CARef znaleziono $stsMsgTp do $mbr $instrId gdzie rsnCd = $rsnCd a
/// oczekiwano rsnCd =
/// $expectedRsnCd');
// return false;
// endif;
// log('$CARef $stsMsgTp do $mbr $instrId status $expectedSts $expectedRsnCd
/// zgodny z
/// oczekiwaniem');
// endif;
//
...
// s = 0;
//
// System.out.println("Metoda polowienia - obliczanie miejsc zerowych funkcji
/// nie liniowych \nna
/// przykladzie
