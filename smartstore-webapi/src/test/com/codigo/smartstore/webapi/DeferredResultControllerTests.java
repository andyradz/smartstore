...
// public class DeferredResultControllerTests extends
...
// MvcResult mvcResult =
// this.mockMvc.perform(get("/async/deferred-result/model-and-view"))
// .andExpect(status().isOk()).andExpect(request().asyncStarted())
...
// MvcResult mvcResult =
// this.mockMvc.perform(get("/async/deferred-result/exception")).andExpect(status().isOk())
